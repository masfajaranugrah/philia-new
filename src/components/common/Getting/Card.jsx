            ...
            >
              <div className="flex flex-col px-2 md:px-10 xl:px-10 lg:px-10 items-center justify-center">
                ...
                <div className="flex md:justify-start md:items-start flex-col lg:w-full md:w-full xl:w-full w-[46%] xl:px-4 md:px-7 mb-7">
                  <button
                    type="button"
                    className="gap-2 font-semibold text-[15x] mt-4 text-center focus:outline-none disabled text-white bg-[#2D210A]  focus:ring-4 focus:ring-green-300 rounded-[5px] rounded px-5 py-1 me-2 mb-2 flex justify-center items-center"
                  >
