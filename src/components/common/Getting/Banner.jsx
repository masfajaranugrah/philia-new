...
function Banner() {
  return (
    <section className="container xl:w-[95%] mb-20 mx-auto rounded rounded-lg relative mt-[20px] lg:mt-[33px] xl:mt-[33px] sm:mt-[20px] md:mt-20 md:px-0 lg:px-0 xl:px-0 px-4">
      <motion.div
