...
>
        ...
        <div className="w-full  flex justify-between items-center max-w-screen-xl">
          ...
          <div className="hidden lg:flex space-x-6">
            ...
            <Link href="/about" className="text-[15px] font-bold">ABOUT</Link>
            <Link href="/getting" className="text-[15px] font-bold">GETTING</Link>
            <Link href="/wahana" className="text-[15px] font-bold">WAHANA </Link>
            <Link href="/tiket" className="text-[15px] font-bold">TIKET</Link>
            <Link href="/question" className="text-[15px] font-bold">FAQ</Link>
            <Link href="/event" className="text-[15px] font-bold">EVENT</Link>
          </div>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <a href="/getting" className="  text-[15px]  block font-bold py-2">GETTING</a>
            ...
            <a href="/question" className="  text-[15px]  block font-bold py-2">FAQ</a>
