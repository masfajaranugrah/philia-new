...
//         </h1>
//       </div>
//       <div className="rounded-xl shadow-lg bg-[#F6FFEA] p-3 md:p-4">
//         {loading ? (
...
//           <div className="bg-[#F6FFEA] p-6 rounded-lg shadow-lg max-w-md w-full">
...
//       {/* Event List */}
// <div className="rounded-xl shadow-lg bg-[#F6FFEA] p-4">
...
// {/* Contact Section */}
// <div className="rounded-xl shadow-lg bg-[#F6FFEA] p-6 text-center">
