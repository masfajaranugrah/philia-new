...
function Banner() {
  return (
    <section className=" xl:mx-[40px] md:mx-[40px] lg:mx-[40px] mb-20   rounded rounded-lg relative mt-[20px] lg:mt-[33px] xl:mt-[33px] sm:mt-[20px] md:mt-20 md:px-0 lg:px-0 xl:px-0 px-4">
      <motion.div
