...
const Card = () => {
  return (
    <div className="relative mt-20">
      ...
      >
        <div className="my-10">
          <h1 className="text-[35px] text-[#2D210A]  font-[1000] text-center">TICKET INFORMATION</h1>
        </div>
      </motion.div>
      ...
      <div className="container mx-auto relative z-10 xl:pb-[40rem] lg:pb-[40rem] md:pb-[10rem] pb-[8rem] md:px-[2rem] lg:px-[10rem] xl:px-[10rem] px-[2rem]">
        ...
        >
          {/* Weekdays Card */}
          <motion.div
            className="p-6 border border-green-900 bg-white rounded-[20px] rounded shadow-[8px_8px_0px_#0A2D19]"
            whileHover={{ scale: 1.05, boxShadow: "8px 8px 15px rgba(0, 0, 0, 0.2)" }}
            whileTap={{ scale: 0.95 }}
          >
            <h3 className="text-[40px] font-[1000] text-center text-[#2D210A]  mb-1">WEEKDAYS</h3>
            <p className="text-[20px] text-center text-[#2D210A] font-semibold mb-1">Last Entry : 19.00</p>
          ...
          {/* Weekend Card */}
          <motion.div
            className="p-6 border border-green-900 rounded-[20px] rounded shadow-[8px_8px_0px_#0A2D19] bg-white"
            whileHover={{ scale: 1.05, boxShadow: "8px 8px 15px rgba(0, 0, 0, 0.2)" }}
            whileTap={{ scale: 0.95 }}
          >
            <h3 className="text-[40px] font-[1000] text-center text-[#2D210A]  mb-1">WEEKEND</h3>
            <p className="text-[20px] text-center text-[#2D210A] font-semibold mb-1">Last Entry : 19.00</p>
        ...
        <motion.div
          className="text-center bg-white p-6 rounded-[20px]  shadow-[8px_8px_0px_#0A2D19]"
          initial={{ opacity: 0 }}
        ...
        >
          <div className="my-4">
            <p className="text-[20px] font-bold text-[#2D210A] ">Check on</p>
            <p className="text-[30px] font-[1000] text-[#2D210A] ">WAHANA TICKET</p>
            <p className="text-[20px] font-bold text-[#2D210A] ">now!</p>
          </div>
